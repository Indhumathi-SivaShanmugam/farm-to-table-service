  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-lg transform transition-transform hover:scale-105">
      ...
      <div className="flex justify-center mb-4">
        <img 
          src="https://th.bing.com/th/id/OIP.eahlcb5aUbjbjugdVlRsYQHaHa?pid=ImgDet&w=474&h=474&rs=1" // Placeholder image for Retailer
          alt="Retailer"
      ...
      <div className="mb-4">
        ...
        <p className="text-gray-600">
          I am a retailer dedicated to providing the best products to my customers.
        </p>
      </div>
